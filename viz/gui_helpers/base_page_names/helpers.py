...
def render_tab_selection(page_name,geo_level=None):
    ...
    tabs_main = [stx.TabBarItemData(id="tab_main_algorithmic", title="Clustering Tabs", description=""),
                 stx.TabBarItemData(id="tab_main_plot", title="Plot Tabs", description="")
                 ]
    ...
    if tab_main_selected == "tab_main_algorithmic":
        tabs=[]
       #222 tabs=[stx.TabBarItemData(id="tab_name_trend_analysis", title="Name Trend Analysis", description="")]
        if geo_level:
       ...
       #333 st.session_state["selected_tab_" +page_name] = stx.tab_bar(data=tabs, default="tab_name_trend_analysis")
